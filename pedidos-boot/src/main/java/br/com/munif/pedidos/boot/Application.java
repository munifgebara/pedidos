package br.com.munif.pedidos.boot;
...
@SpringBootApplication(scanBasePackages = {"br.com.munif.pedidos.boot.components",
                                           "br.com.munif.pedidos.application.service",
                                           "io.gumga",
                                           "br.com.munif.pedidos.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"br.com.munif.pedidos.application.repository", "io.gumga"})
...
public class Application {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "br.com.munif.pedidos.domain.model");
